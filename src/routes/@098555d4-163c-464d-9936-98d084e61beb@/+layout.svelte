<script>
	...
	import { WEBUI_API_BASE_URL, WEBUI_BASE_PATH, WEBUI_PREFIX, WEBUI_BASE_URL_PLAIN, WEBUI_BASE_URL, WEBUI_HOSTNAME } from '$lib/constants';
	import {
	...
	const setupSocket = async (enableWebsocket) => {
		const _socket = io(`${WEBUI_BASE_URL_PLAIN}` || undefined, {
			reconnection: true,
	...
	const redirectToAuthAfterUnauthorized = () => {
		...
		goto(`${WEBUI_BASE_PATH}/auth?redirect=${encodeURIComponent(currentPath)}`).finally(() => {
